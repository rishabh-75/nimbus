...
class Sidebar(QWidget):
    ...
    def _build_ui(self):
        ...
        self._dm_score_lbl.setWordWrap(True)
    ...
    def update_dual_mode(self, dm_sig):
        ...
        try:
            ...
            self._dm_sma_lbl.setText(
                f"SMA: {pct:+.1f}% | DD: {dm_sig.dd_from_high:.1f}%"
                f" | {dm_sig.red_streak}d red"
            )
