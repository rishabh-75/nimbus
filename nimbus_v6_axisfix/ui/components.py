...
from ui.theme import (
    ...
    VIOLET, FONT_MONO, FONT_UI, BADGE_STYLES, SIZING_STYLES,
)
...
class ChecklistRow(QWidget):
    ...
    _ICONS = {
        "pass": ("✓", GREEN), "warn": ("!", GOLD),
        "fail": ("✗", RED),   "neutral": ("-", MUTED),
    }
