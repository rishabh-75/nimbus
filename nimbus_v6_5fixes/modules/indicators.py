...
class PriceSignals:
    ...
    # Used by deal conviction model (D2 — ADV multiple)
    adv_cr: float = 0.0
...
def compute_price_signals(
    ...
    # ── ADV (Phase 1) — 20-day average daily turnover in Rs Cr ────────────
    # Volume column is "Volume" (capitalized) in yfinance 4H data
